...
public class BasePresenterImpl implements BasePresenter, FragmentCalculatorContract.OnFileSentToFirebaseListener {
    ...
    @Override
    public void sendFilefromCameraToFirebase(Context mContext, StorageReference storageReference, final File file, final DatabaseReference databaseReference, final User userModel, @Nullable final ChatModel chatModel, @Nullable final PaymentModel paymentModel) {
    ...
    @Override
    public void sendFileFromGalleryTofirebase(StorageReference storageReference, Uri file, final DatabaseReference databaseReference, final User userModel, @Nullable final ChatModel chatModel, @Nullable final PaymentModel paymentModel) {
        if (storageReference != null) {
