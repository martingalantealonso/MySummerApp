...
public class ParticlesDrawable extends Drawable implements Animatable, Runnable {
     ...
     */
    private void drawDot(@NonNull final Canvas canvas, @NonNull final ParticleDot p) {
     ...
     */
    private void drawLine(@NonNull final Canvas canvas, @NonNull final ParticleDot p1, @NonNull final ParticleDot p2, final float distance) {
     ...
     */
    private static float distance(final float ax, final float ay, final float bx, final float by) {
     ...
     */
    private static float angleDeg(final float ax, final float ay, final float bx, final float by) {
